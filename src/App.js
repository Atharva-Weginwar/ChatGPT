...
function App() {
  ...
  const[messages, setMessages] = useState([
    {
    text: "Hi, I am ChatGPT, a language model created by OpenAI based on the GPT-3.5 architecture. My purpose is to generate human-like text based on the input I receive. I'm part of the GPT-3 model family, which stands for Generative Pre-trained Transformer.",
    isBot: true,
    }
  ]);
    ...
    <div className="App">
      ...
      <div className="main">
        ...
        <div className="chatFooter">
          ...
          <p>ChatGPT may produce inaccurate information about people,places, or facts. ChatGPT December 23 Version - By Atharva Weginwar</p>
        </div>
      </div>
    </div>
  );
